    ...
    public class StoreRoleDictionaryDB : BaseDBConnector<Tuple<int,String,String,String>>
    {
        ...
        public override LinkedList<Tuple<int, String, String,String>> Get()
        {
            ...
            while (reader.Read())
            {
                ...
                Tuple<int, String, String,String> t = new Tuple<int, String, String,String>(storeId,userName,storeRole, addedBy);
        ...
        public override Boolean Add(Tuple<int, String, String,String> t)
        {
            try
            {
                ...
                string sql = "INSERT INTO StoreRoleDictionary (storeId, userName, storeRole, addedBy)" +
                             " VALUES (" + t.Item1+ ", '" + t.Item2 + "', '" + t.Item3 + "', '" + t.Item4 + "')";
                MySqlCommand cmd = new MySqlCommand(sql, con);
                cmd.ExecuteNonQuery();
                con.Close();
                return true;
        ...
        public override Boolean Remove(Tuple<int, String, String, String> t)
        {
            try
            {
                con.Open();
